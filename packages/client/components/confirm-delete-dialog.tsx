    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <div className="space-y-3">
          <label className="text-xs text-muted-foreground block">Type the title to confirm</label>
          <Input value={input} onChange={(e) => setInput(e.target.value)} placeholder={`Type "${title}" to confirm`} />
        </div>
